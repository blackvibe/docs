...
Каждый режим запоминает последнюю использованную модель. При переключении режимов Harvi Code автоматически выберет эту модель - не нужно выбирать вручную. Можешь назначить разные модели разным режимам, и Harvi Code будет автоматически переключать модели при смене режима.
